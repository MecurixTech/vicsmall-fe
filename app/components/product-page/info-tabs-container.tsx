...
const InfoTabs = ({ product }: InfoTabsProps) => {
  ...
  return (
    <section className="rounded-xl bg-white p-2 shadow-lg mt-8">
      <div className="mb-4 flex flex-wrap justify-start gap-2 rounded-lg text-gray-400">
        <button
          onClick={() => setActiveTab("overview")}
          className={`${
            activeTab === "overview" ? "bg-white font-medium text-gray-600" : "bg-neutral-light-gray text-gray-400"
        ...
        <button
          ...
          className={`${
            activeTab === "vendor" ? "bg-white font-medium text-gray-600" : "bg-neutral-light-gray text-gray-400"
          } border px-4 py-2 transition-all duration-200`}
        >
          Vendor info
        </button>
        <button
          ...
          className={`${
            activeTab === "shipping" ? "bg-white font-medium text-gray-600" : "bg-neutral-light-gray text-gray-400"
          } rounded-xl border px-4 py-2 transition-all duration-200`}
        >
          Shipping
        </button>
