...
const Banner = () => {
  ...
  return (
    <section className="relative mx-auto mt-24 flex h-auto w-full max-w-screen-xl flex-col items-center justify-between overflow-hidden rounded-[23px] bg-[#FF8C48] px-4 py-8 sm:mt-20 sm:flex-row sm:px-8 lg:px-16 lg:py-12">
      <div
